        ...
        <form action="{{ route('characters.update', $character) }}" method="POST">
            ...
            <div class="row g-3">
                <div class="col-6">
                    ...
                    <input value="{{ $character->name }}" type="text" class="form-control" id="name" name="name"
                        required>
                </div>
                <div class="col-6">
                    <label for="attack" class="form-label">Attacco</label>
                    <input value="{{ $character->attack }}" type="number" class="form-control" id="attack"
                        name="attack" required>
                </div>
                <div class="col-6">
                    <label for="defense" class="form-label">Difesa</label>
                    <input value="{{ $character->defense }}" type="number" class="form-control" id="defense"
                        name="defense" required>
                </div>
                <div class="col-6">
                    <label for="speed" class="form-label">Velocità</label>
                    <input value="{{ $character->speed }}" type="number" class="form-control" id="speed" name="speed"
                        required>
                </div>
                <div class="col-6">
                    <label for="life" class="form-label">Vita</label>
                    <input value="{{ $character->life }}" type="number" class="form-control" id="life" name="life"
                        required>
                </div>
